...
steps:
  ...
  - uses: devantler-tech/.github/actions/validate-retired-repo-links@<full-commit-sha>
    with:
      enabled: "true"
```
...
[devantler-tech/actions#1350](https://github.com/devantler-tech/actions/issues/1350).
...
```bash
go -C actions/validate-retired-repo-links test -race -cover ./...
go -C actions/validate-retired-repo-links vet ./...
```
