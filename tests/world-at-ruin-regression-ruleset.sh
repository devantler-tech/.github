...
grep -Fq '10 of the 24 org rulesets' "${repo_root}/deploy/organization-rulesets/README.md" ||
  fail "organization ruleset inventory must account for 10 imported, 4 managed, and 10 UI-managed rulesets"
